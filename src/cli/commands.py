...
def run_workflow_command(argv: list[str]) -> int:
    from scripts.run_end_to_end_workflow import main

    return int(main(argv))


def run_automation_command(argv: list[str]) -> int:
    from scripts.run_workflow_automation import main
...
def run_research_governance_command(argv: list[str]) -> int:
    from scripts.run_research_governance_pipeline import main
